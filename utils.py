...
def tokenize_data(example_dict, tokenizer, is_train, max_length=1024):
    ...
    for question, code, answer in zip(example_dict["question"], example_dict["generated_code_string"], example_dict["answer"]):
...
class PaddedDataCollator:
    ...
    def __call__(self, features):
        ...
        for feature in features:
            ...
            labels = [-100] * (max_input_length - len(feature['input_ids']) + feature["source_len"]) + feature['input_ids'][feature["source_len"]:]
